...
13. [ ] Release 1.0.0 `[human]` — delivers: the plugin published at version parity with a tag and release — acceptance: CHANGELOG, plugin and marketplace versions agree; tag and GitHub release exist — seams: the release workflow's own checks — blocked by: #9 #10 #11 #12 #14 — from decision #7
